...
exports = module.exports = class base {
    ...
    process_all() {
        let t = this, obj, msg, xItems = null, pro, itm
            ...
            if (i == t.process_item) {
                if (typeof props != 'undefined' && typeof props.the != 'undefined' && props.the == 'end') {
                    if (t.any_errors)
                        ...
                        t.dt_end = new Date(); 
                        t.resolve_array[i](`success start(${t.dt_start}) end(${t.dt_end}) milliseconds(${t.dt_end - t.dt_start })`)
                    }
                    return
                }
                        ...
                        if (x == t.process_array_item) {
                            ...
                            pro((obj_props) => {
                                ...
                                if (t.process_array_item < xItems.length)
                                    ...
                                    t.dt_end = new Date(); 
                                    msg = `success start(${t.dt_start}) end(${t.dt_end}) milliseconds(${t.dt_end - t.dt_start })`
